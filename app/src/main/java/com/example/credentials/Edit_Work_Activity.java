...
import com.example.credentials.databinding.ActivityEditWorkBinding;

import java.util.Objects;

public class Edit_Work_Activity extends AppCompatActivity {
